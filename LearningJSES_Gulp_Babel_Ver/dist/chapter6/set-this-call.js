...
*/
var newBruce = [1940, "martial artist"];
update.call.apply(update, [bruce].concat(newBruce)); // apply(bruce, newBruce)와 같습니다.
Math.min.apply(Math, _toConsumableArray(arr)); // -5
Math.max.apply(Math, _toConsumableArray(arr)); // 15
/*
...
var updateBruce1949 = update.bind(bruce, 1949);
